...
TEST_CASE("DataSet-getMetadata", "[core][dataset]")
{
    ...
    SECTION("Mini2p Normal Movie")
    {
        const std::string filePath = g_resources["unitTestDataPath"] + "/mini2p/lens/zstack_planes_2025-05-07-15-51-40_video-TPC.isxd";
        isx::DataSet ds("movie", isx::DataSet::Type::MOVIE, filePath, isx::HistoricalDetails());

        const std::map<std::string, std::string> metaData = convertMetadataToMap(ds.getMetadata());

        REQUIRE(metaData.at("Start Time") == "2025/05/07-15:51:42.718");
        REQUIRE(metaData.at("End Time") == "2025/05/07-15:51:43.373");
        REQUIRE(metaData.at("Duration (s)") == "0.656");
        REQUIRE(metaData.at("Sample Rate (Hz)") == "15.252");
        ...
        REQUIRE(metaData.at("Microns per Pixel") == "0.808");
        REQUIRE(metaData.at("Animal Date of Birth") == "");
        REQUIRE(metaData.at("Animal ID") == "");
        ...
        REQUIRE(metaData.at("Experimenter Name") == "");
        REQUIRE(metaData.at("Microscope Focus") == "680");
        REQUIRE(metaData.at("Microscope Gain") == "7");
        REQUIRE(metaData.at("Microscope Power") == "5.600");
        REQUIRE(metaData.at("Microscope Serial Number") == "KA-25013002");
        REQUIRE(metaData.at("Microscope Type") == "default");
        REQUIRE(metaData.at("Recording UUID") == "KA-02102025-0000000000-1746633100914");
        REQUIRE(metaData.at("Session Name") == "zstack_planes_20250507-151707");
        REQUIRE(metaData.at("Z-Stack") == "false");
    }

    SECTION("Mini2p Z-Stack")
    {
        const std::string filePath = g_resources["unitTestDataPath"] + "/mini2p/zstack/zstack_planes_2025-05-07-15-51-30_stack.isxd";
        isx::DataSet ds("movie", isx::DataSet::Type::MOVIE, filePath, isx::HistoricalDetails());

        const std::map<std::string, std::string> metaData = convertMetadataToMap(ds.getMetadata());

        REQUIRE(metaData.at("Start Time") == "2025/05/07-15:51:32.278");
        REQUIRE(metaData.at("End Time") == "2025/05/07-15:51:33.589");
        REQUIRE(metaData.at("Duration (s)") == "1.311");
        REQUIRE(metaData.at("Sample Rate (Hz)") == "7.626");
        REQUIRE(metaData.at("Number of Time Samples") == "10");
        REQUIRE(metaData.at("Number of Dropped Samples") == "0");
        REQUIRE(metaData.at("Number of Cropped Samples") == "0");
        REQUIRE(metaData.at("Number of Blank Samples") == "0");
        REQUIRE(metaData.at("Number of Pixels") == "512 x 512");
        REQUIRE(metaData.at("Microns per Pixel") == "0.782");
        REQUIRE(metaData.at("Animal Date of Birth") == "");
        REQUIRE(metaData.at("Animal ID") == "");
        REQUIRE(metaData.at("Animal Sex") == "");
        REQUIRE(metaData.at("Animal Species") == "");
        ...
        REQUIRE(metaData.at("Microscope Serial Number") == "KA-25013002");
        REQUIRE(metaData.at("Microscope Type") == "default");
        REQUIRE(metaData.at("Recording UUID") == "KA-02102025-0000000000-1746633090335");
        REQUIRE(metaData.at("Session Name") == "zstack_planes_20250507-151707");
        REQUIRE(metaData.at("Z-Stack") == "true");
        REQUIRE(metaData.at("Z-Stack Planes") == "[400,466,533,600,666,733,800,866,933,1000]");
    }
