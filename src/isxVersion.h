...
#if APP_VERSION_PATCH < 10
#define APP_VERSION_PATCH_FIXED  "0"
#else
#define APP_VERSION_PATCH_FIXED
#endif
...
#define APP_VERSION_STR       STR(APP_VERSION_MAJOR) "." APP_VERSION_MINOR_FIXED STR(APP_VERSION_MINOR) "." APP_VERSION_PATCH_FIXED STR(APP_VERSION_PATCH) 
