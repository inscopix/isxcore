...
namespace isx
{
        ...
        m_fileName(inFileName)
    {
        ...
        if (!m_file.good() || !m_file.is_open())
        {
            ISX_THROW(isx::ExceptionFileIO,
                "Failed to open vessel set file for reading (", m_fileName, ")", " with error: ", getSystemErrorString());
        }
        readHeader();
                ...
                , m_vesselSetType(inVesselSetType)
    {
        ...
        {
            ISX_THROW(isx::ExceptionFileIO,
                "Failed to open vessel set file for read/write (", m_fileName, ")", " with error: ", getSystemErrorString());
        }
        m_valid = true;
    }
